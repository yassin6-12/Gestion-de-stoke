				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<ul class="product-btns">
								<li><a href="#" class="text-decoration-none"><i class="fa fa-heart-o"></i> add to wishlist</a></li>
								<li><a href="#" class="text-decoration-none"><i class="fa fa-exchange"></i> add to compare</a></li>
							</ul>
					...
					<div class="col-md-12">
						<div id="product-tab">
							<!-- product tab nav -->
							<ul class="tab-nav">
								<li class="active"><a href="#tab1" class="text-decoration-none collapse-btn-product">Description</a></li>
								<li><a href="#tab2" class="text-decoration-none collapse-btn-product">Details</a></li>
